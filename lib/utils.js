 ...
 */
function determinarTipo2(elemento) {
    if (elemento === null) return "null";
    if (elemento !== elemento) return "NaN";
    if (elemento === Infinity || elemento === -Infinity) return "Infinity";
    if (typeof elemento !== "object") return typeof elemento; // boolean, string, function, undefined, number ou bigint.
